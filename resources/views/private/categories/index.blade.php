<x-app-layout>
    <x-slot name="header">
        <div class="d-flex align-items-center p-3 my-3 text-white bg-color-present rounded shadow-sm">
            <div class="lh-1">
                <h1 class="h6 mb-0 text-white lh-1">CRUD CATEGOR&Iacute;AS</h1>
            </div>
        </div>
        <div class="mt-3">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Categor&iacute;as</li>
                </ol>
            </nav>
            @can('Crear Categoría')
                <div class="nav justify-content-end mb-2">
                    <a href="{{ route('categories.create') }}" class="btn btn-success"><svg
